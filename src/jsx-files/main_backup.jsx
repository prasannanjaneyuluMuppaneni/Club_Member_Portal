...
function Chat({
    ...
    const searchDocuments = (question) => {
        ...
        /* Common words that do not help identify a document. */
        const stopWords = new Set([
            'a', 'an', 'the', 'and', 'or', 'for', 'are', 'what', 'when',
            'where', 'which', 'how', 'can', 'does', 'this', 'that', 'with',
            'from', 'about', 'into', 'your', 'you', 'have', 'has', 'was',
            'were', 'will', 'would', 'could', 'should', 'please', 'tell',
            'give', 'show', 'me', 'why', 'who', 'not', 'our', 'their',
            'there', 'they', 'them', 'then', 'than', 'also', 'just', 'need',
            'want', 'know', 'does', 'do', 'is', 'in', 'on', 'to', 'of', 'my',
            'i', 'it', 'be', 'as', 'at', 'by', 'we', 'all', 'any', 'more'
        ]);
        ...
        Object.entries(docContents).forEach(
            ([fileName, content]) => {
                ...
                /* Search paragraph/section by paragraph. */
                const paragraphs =
                    content
                        .split(/\n\s*\n/)
                ...
                paragraphs.forEach(paragraph => {
                    ...
                    /* Exact question/phrase match gets a strong bonus. */
                    const phrase = meaningfulWords.join(' ');
                    if (phrase.length > 5 && lowerParagraph.includes(phrase)) {
                        score += 5;
                    }
        ...
        /* Highest relevance first; keep only the best three sections. */
